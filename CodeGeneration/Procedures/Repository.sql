...
--------------------------------------------------------------------------------------------------------------------------------
IF OBJECT_ID('GetAllPageTag') IS NOT NULL
BEGIN--IF
	DROP PROCEDURE [GetAllPageTag]
END--IF
GO

CREATE PROCEDURE [GetAllPageTag] AS
BEGIN--PROCEDURE
	SET NOCOUNT ON;
...
--------------------------------------------------------------------------------------------------------------------------------
IF OBJECT_ID('DeletePageTagById') IS NOT NULL
BEGIN--IF
	DROP PROCEDURE [DeletePageTagById]
END--IF
GO

CREATE PROCEDURE [DeletePageTagById]
(
	@Id Int
) AS
BEGIN--PROCEDURE
...
--------------------------------------------------------------------------------------------------------------------------------
IF OBJECT_ID('GetPageTagById') IS NOT NULL
BEGIN--IF
	DROP PROCEDURE [GetPageTagById]
END--IF
GO

CREATE PROCEDURE [GetPageTagById]
(
	@Id Int
) AS
BEGIN--PROCEDURE
...
--------------------------------------------------------------------------------------------------------------------------------
IF OBJECT_ID('UpdatePageTagById') IS NOT NULL
BEGIN--IF
	DROP PROCEDURE [UpdatePageTagById]
END--IF
GO



CREATE PROCEDURE [UpdatePageTagById]
(
	@Id as int,
	@PageId as int,
	@Tag as nvarchar (128)
...
--------------------------------------------------------------------------------------------------------------------------------
IF OBJECT_ID('InsertPageTag') IS NOT NULL
BEGIN--IF
	DROP PROCEDURE [InsertPageTag]
END--IF
GO



CREATE PROCEDURE [InsertPageTag]
(
	@PageId as int,
	@Tag as nvarchar (128)
) AS
