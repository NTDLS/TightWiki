...
--------------------------------------------------------------------------------------------------------------------------------
IF OBJECT_ID('GetAllProcessingInstruction') IS NOT NULL
BEGIN--IF
	DROP PROCEDURE [GetAllProcessingInstruction]
END--IF
GO

CREATE PROCEDURE [GetAllProcessingInstruction] AS
BEGIN--PROCEDURE
	SET NOCOUNT ON;
...
--------------------------------------------------------------------------------------------------------------------------------
IF OBJECT_ID('DeleteProcessingInstructionById') IS NOT NULL
BEGIN--IF
	DROP PROCEDURE [DeleteProcessingInstructionById]
END--IF
GO

CREATE PROCEDURE [DeleteProcessingInstructionById]
(
	@Id Int
) AS
BEGIN--PROCEDURE
...
--------------------------------------------------------------------------------------------------------------------------------
IF OBJECT_ID('GetProcessingInstructionById') IS NOT NULL
BEGIN--IF
	DROP PROCEDURE [GetProcessingInstructionById]
END--IF
GO

CREATE PROCEDURE [GetProcessingInstructionById]
(
	@Id Int
) AS
BEGIN--PROCEDURE
...
--------------------------------------------------------------------------------------------------------------------------------
IF OBJECT_ID('UpdateProcessingInstructionById') IS NOT NULL
BEGIN--IF
	DROP PROCEDURE [UpdateProcessingInstructionById]
END--IF
GO



CREATE PROCEDURE [UpdateProcessingInstructionById]
(
	@PageId as int,
	@Instruction as nvarchar (128),
	@Id as int = NULL
) AS
BEGIN--PROCEDURE
	SET NOCOUNT ON;
...
--------------------------------------------------------------------------------------------------------------------------------
IF OBJECT_ID('InsertProcessingInstruction') IS NOT NULL
BEGIN--IF
	DROP PROCEDURE [InsertProcessingInstruction]
END--IF
GO



CREATE PROCEDURE [InsertProcessingInstruction]
(
	@PageId as int,
	@Instruction as nvarchar (128),
	@Id as int = NULL
