...
namespace TightWiki.Library.Wiki
{
    public partial class Wikifier
    {
        ...
        public Wikifier(StateContext context, Page page, int? revision,
        ...
        private void Transform()
        {
            ...
            if (_revision != null)
            {
                ...
                html.Append($"<p class=\"card-text\">You are viewing revision {_revision:0} of \"{_page.Name}\" modified by \"{revision?.ModifiedByUserName}\" on {_context.LocalizeDateTime(revision?.ModifiedDate ?? DateTime.MinValue)}. <br />");
                    ...
                    case "history":
                        {
                            ...
                            if (history.Count() > 0)
                            {
                                ...
                                {
                                    html.Append($"<li><a href=\"/{item.Navigation}/{item.Revision}\">{item.Revision} by {item.ModifiedByUserName} on {_context.LocalizeDateTime(item.ModifiedDate)}</a>");
