...
namespace TightWiki
{
    public class TwInvariantDecimalModelBinderProvider
        : IModelBinderProvider
    {
        public IModelBinder? GetBinder(ModelBinderProviderContext context)
        {
            ...
            if (!context.Metadata.IsComplexType && (context.Metadata.ModelType == typeof(decimal) || context.Metadata.ModelType == typeof(decimal?)))
            {
                ...
                return new TwInvariantDecimalModelBinder(context.Metadata.ModelType, loggerFactory.EnsureNotNull());
            }
    ...
    public class TwInvariantDecimalModelBinder(Type modelType, ILoggerFactory loggerFactory)
        : IModelBinder
    {
