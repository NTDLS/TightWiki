...
/*! `wiki` grammar compiled for Highlight.js 11.6.0 */
(() => {
    var e = (() => {
        "use strict"; return e => {
            const n = e.regex, t = /\d{1,2}\/\d{1,2}\/\d{4}/, a = /\d{4}-\d{1,2}-\d{1,2}/, i = /(\d|1[012])(:\d+){0,2} *(AM|PM)/, s = /\d{1,2}(:\d{1,2}){1,2}/, r = {
                ...
                ; return {
                    name: "wiki++", aliases: ["wiki"], case_insensitive: !0,
                    classNameAliases: { label: "symbol" }, keywords: {
                        keyword: "Code Bullets Jumbotron Callout Background Foreground Alert Card Collpase Tag SearchList TagList SearchCloud TagGlossary RecentlyModified TextGlossary TagCloud Image File Related Tags EditLink Inject BR NL HR NewLine History Attachments TOC Title Navigation Name Created LastModified AppVersion Deprecate Protect Template Review Include Draft",
                        built_in: "infinite",
                        type: "boolean integer string decimal",
                        literal: "true false null"
                    },
                    illegal: "//|\\{|\\}|^\\$ ", contains: [{
                        className: "string", begin: /"(""|[^/n])"C\b/
