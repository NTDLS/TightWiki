...
(function (mod) {
    ...
    CodeMirror.defineMode("tightwiki", function () {
        var functions = ["##systememojicategorylist", "##systememojilist", "##set", "##seq", "##get", "##color", "##searchlist", "##taglist", "##searchcloud", "##tagglossary", "##mostedited", "##recentlymodified", "##recentlcreated", "##mostviewed", "##textglossary", "##tagcloud", "##image", "##file", "##related", "##tags", "##editlink", "##inject", "##include", "##br", "##hr", "##revisions", "##attachments", "##toc", "##title", "##navigation", "##name", "##created", "##lastmodified", "##sitename", "##appversion", "##profileglossary", "##profilelist", "##namespaceglossary", "##namespacelist", "##namespace", "##snippet", "##description", "##pagerevisioncount", "##pageviewcount", "##createdby", "##lastmodifiedby", "##pageurl", "##pageid", "##pagecommentcount", "##backlinks"],
