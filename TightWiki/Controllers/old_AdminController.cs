...
namespace TightWiki.Controllers
{
    [Authorize]
    [Route("[controller]")]
    public class old_AdminController(
        ITightEngine tightEngine,
        SignInManager<IdentityUser> signInManager,
        UserManager<IdentityUser> userManager,
        IStringLocalizer<old_AdminController> localizer)
        : WikiControllerBase<old_AdminController>(signInManager, userManager, localizer)
    {
        #region Metrics.
