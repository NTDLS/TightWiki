...
{
    /// <summary>
    /// Represents the result of inserting a new role permission record,
    /// returning the identity and details of the permission that was created.
    /// </summary>
    public class TwInsertRolePermissionResult
    {
        /// <summary>
        /// The unique identifier of the role permission record that was created.
        /// </summary>
