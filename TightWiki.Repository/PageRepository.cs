...
namespace TightWiki.Repository
{
    public static class PageRepository
    {
        ...
        public static List<PageComment> GetPageCommentsPaged(string navigation, int pageNumber, bool allowCache = true, int? pageSize = null)
        {
            pageSize ??= GlobalConfiguration.PaginationSize;
        ...
        public static List<Page> GetAllPagesByInstructionPaged(int pageNumber, string? instruction = null, int? pageSize = null)
        {
            pageSize ??= GlobalConfiguration.PaginationSize;
        ...
        public static List<Page> GetAllPagesPaged(int pageNumber,
            string? orderBy = null, string? orderByDirection = null, List<string>? searchTerms = null, int? pageSize = null)
        {
            pageSize ??= GlobalConfiguration.PaginationSize;
        ...
        public static List<Page> GetAllDeletedPagesPaged(int pageNumber, string? orderBy = null,
            string? orderByDirection = null, List<string>? searchTerms = null, int? pageSize = null)
        {
            pageSize ??= GlobalConfiguration.PaginationSize;
