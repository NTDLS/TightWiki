...
namespace TightWiki.Plugin.Default.StandardFunctions
{
    ...
    {
        [TwStandardFunctionPlugin("Color", "Applies a color to the given text.", isLitePermissiable: true)]
        ...
        [TwStandardFunctionPlugin("BR", "Inserts a line break into the page.", isLitePermissiable: true)]
        public async Task<TwPluginResult> BR(ITwEngineState state, int count = 1) => await NewLine(state, count);

        [TwStandardFunctionPlugin("NL", "Inserts a line break into the page.", isLitePermissiable: true)]
        public async Task<TwPluginResult> NL(ITwEngineState state, int count = 1) => await NewLine(state, count);

        [TwStandardFunctionPlugin("NewLine", "Inserts a line break into the page.", isLitePermissiable: true)]
        ...
        [TwStandardFunctionPlugin("HR", "Inserts a horizontal rule into the page.", isLitePermissiable: true)]
