...
{
    public class TightEngineFunctionDescriptor
    {
        /// <summary>
        ...
        /// </summary>
        public ITightWikiFunctionDescriptorAttribute Attribute { get; }
        ...
        public TightEngineFunctionDescriptor(TightEngineFunctionModule engineModule, MethodInfo method, ITightWikiFunctionDescriptorAttribute attribute)
        {
