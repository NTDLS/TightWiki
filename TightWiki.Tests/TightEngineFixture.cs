...
{
    public class TightEngineFixture
    {
        ...
        public TightEngineFixture(ITestOutputHelper output)
        {
            _output = output;
        ...
        public async Task<ITightEngineState> WikiTransform(string pageName, string body)
        {
