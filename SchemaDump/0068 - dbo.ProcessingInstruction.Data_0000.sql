CREATE TABLE #tmp_3dd6572d15704e75bcc38b356d386287 ([PageId] [int],[Instruction] [nvarchar](128))
GO

INSERT INTO #tmp_3dd6572d15704e75bcc38b356d386287 ([PageId],[Instruction]) VALUES
(1,'Protect'),
(36,'Draft'),
(55,'Draft'),
(56,'Draft'),
...
INNER JOIN #tmp_3dd6572d15704e75bcc38b356d386287 as S
...
SELECT
	[PageId],[Instruction]
FROM #tmp_3dd6572d15704e75bcc38b356d386287 as S
WHERE NOT EXISTS (
...
GO
DROP TABLE #tmp_3dd6572d15704e75bcc38b356d386287
GO
