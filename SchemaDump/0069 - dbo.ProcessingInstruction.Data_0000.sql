CREATE TABLE #tmp_45ac970659844c6cb72b4974972f095b ([PageId] [int],[Instruction] [nvarchar](128))
GO

INSERT INTO #tmp_45ac970659844c6cb72b4974972f095b ([PageId],[Instruction]) VALUES
(1,'Protect'),
(36,'Draft'),
(55,'Draft'),
(56,'Draft'),
...
INNER JOIN #tmp_45ac970659844c6cb72b4974972f095b as S
...
SELECT
	[PageId],[Instruction]
FROM #tmp_45ac970659844c6cb72b4974972f095b as S
WHERE NOT EXISTS (
...
GO
DROP TABLE #tmp_45ac970659844c6cb72b4974972f095b
GO
