CREATE TABLE #tmp_847b08de0e7a4acc900dd3e4148c72cf ([Id] [int],[Name] [nvarchar](128),[Navigation] [nvarchar](128),[Description] [nvarchar](max),[Revision] [int],[CreatedByUserId] [int],[CreatedDate] [datetime],[ModifiedByUserId] [int],[ModifiedDate] [datetime])
GO

INSERT INTO #tmp_847b08de0e7a4acc900dd3e4148c72cf ([Name],[Navigation],[Description],[Revision],[CreatedByUserId],[CreatedDate],[ModifiedByUserId],[ModifiedDate]) VALUES
...
('Development Notes','Development_Notes','Notes on what we need to do, and how to do what''s already here.',3,2,'9/16/2022 3:41:43 PM',7,'10/19/2022 3:42:45 PM'),
...
('Fallout Heads','Fallout_Heads','Heads, from fallout - need we say more?',2,1,'9/30/2022 1:11:34 PM',7,'10/18/2022 9:06:47 PM'),
...
SELECT
	[Name],[Navigation],[Description],[Revision],[CreatedByUserId],[CreatedDate],[ModifiedByUserId],[ModifiedDate]
FROM #tmp_847b08de0e7a4acc900dd3e4148c72cf as S
ALTER TABLE [dbo].[Page] CHECK CONSTRAINT ALL
GO
DROP TABLE #tmp_847b08de0e7a4acc900dd3e4148c72cf
GO
