CREATE TABLE #tmp_4e9bd1e1db5b4ac1a365d20f018d3a36 ([Id] [int],[ConfigurationGroupId] [int],[Name] [nvarchar](128),[Value] [nvarchar](max),[DataTypeId] [int],[Description] [nvarchar](1000),[IsEncrypted] [bit])
GO

INSERT INTO #tmp_4e9bd1e1db5b4ac1a365d20f018d3a36 ([ConfigurationGroupId],[Name],[Value],[DataTypeId],[Description],[IsEncrypted]) VALUES
...
INNER JOIN #tmp_4e9bd1e1db5b4ac1a365d20f018d3a36 as S
...
SELECT
	[ConfigurationGroupId],[Name],[Value],[DataTypeId],[Description],[IsEncrypted]
FROM #tmp_4e9bd1e1db5b4ac1a365d20f018d3a36 as S
WHERE NOT EXISTS (
...
GO
DROP TABLE #tmp_4e9bd1e1db5b4ac1a365d20f018d3a36
GO
