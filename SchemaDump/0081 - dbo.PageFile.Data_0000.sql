CREATE TABLE #tmp_4364095dca5a414e988b78b290834b6f ([Id] [int],[PageId] [int],[Name] [nvarchar](250),[Navigation] [nvarchar](250),[Revision] [int],[CreatedDate] [datetime])
GO

INSERT INTO #tmp_4364095dca5a414e988b78b290834b6f ([PageId],[Name],[Navigation],[Revision],[CreatedDate]) VALUES
...
SELECT
	[PageId],[Name],[Navigation],[Revision],[CreatedDate]
FROM #tmp_4364095dca5a414e988b78b290834b6f as S
ALTER TABLE [dbo].[PageFile] CHECK CONSTRAINT ALL
GO
DROP TABLE #tmp_4364095dca5a414e988b78b290834b6f
GO
