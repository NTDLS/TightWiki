CREATE TABLE #tmp_83b462a5edb04af397340acae4e9c608 ([Id] [int],[ConfigurationGroupId] [int],[Name] [nvarchar](128),[Value] [nvarchar](max),[DataTypeId] [int],[Description] [nvarchar](1000),[IsEncrypted] [bit])
GO

INSERT INTO #tmp_83b462a5edb04af397340acae4e9c608 ([ConfigurationGroupId],[Name],[Value],[DataTypeId],[Description],[IsEncrypted]) VALUES
...
(1,'Default Country','US',2,'The country to use for the site culture for guests.',0),
(1,'Default Language','English',2,'The language to use for the site culture for guests.',0),
(1,'Default TimeZone','Eastern Standard Time',2,'The timezone to use for the site culture for guests.',0),
(1,'FooterBlurb','TightWiki is an aspnet core MVC Wiki built on top of SQL Server and various other Microsoft technologies.',2,'The footer of the wiki, this is shown at the botton of all pages.',0),
...
(4,'Default Country','US',2,'The default country to use for new accounts.',0),
(4,'Default Language','English',2,'The default language to use for new accounts.',0),
(4,'Default Signup Role','Contributor',2,'The default role to assign accounts when they singup.',0),
(4,'Default TimeZone','Eastern Standard Time',2,'The default timezone to use for new accounts.',0),
...
INNER JOIN #tmp_83b462a5edb04af397340acae4e9c608 as S
...
SELECT
	[ConfigurationGroupId],[Name],[Value],[DataTypeId],[Description],[IsEncrypted]
FROM #tmp_83b462a5edb04af397340acae4e9c608 as S
WHERE NOT EXISTS (
...
GO
DROP TABLE #tmp_83b462a5edb04af397340acae4e9c608
GO
