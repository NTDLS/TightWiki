CREATE TABLE #tmp_36e22d6e39a4498581269290c771a671 ([Id] [int],[ConfigurationGroupId] [int],[Name] [nvarchar](128),[Value] [nvarchar](255),[DataTypeId] [int],[Description] [nvarchar](1000),[IsEncrypted] [bit])
GO

INSERT INTO #tmp_36e22d6e39a4498581269290c771a671 ([ConfigurationGroupId],[Name],[Value],[DataTypeId],[Description],[IsEncrypted]) VALUES
(1,'Brand Image (Small)','/images/ASAP Wiki Icon 32.png',2,'The brand image of the wiki, this is displayed on the top of all wiki pages.',0),
...
(1,'FooterBlurb','ASAP!Wiki! is a free and opensource .NET MVC Wiki built on top of SQL Server and various other Microsoft technologies. Feel free to tweak, contort and otherwise use as you desire. Enjoy!',2,'The footer of the wiki, this is shown at the botton of all pages.',0),
(1,'Name','ASAP! WIKI!',2,'The name of the wiki, this is displayed everwhere.',0),
...
(5,'SMTP.From Display Name','ASAP Wiki',2,'The display name to show for all email communications.',0),
...
INNER JOIN #tmp_36e22d6e39a4498581269290c771a671 as S
...
SELECT
	[ConfigurationGroupId],[Name],[Value],[DataTypeId],[Description],[IsEncrypted]
FROM #tmp_36e22d6e39a4498581269290c771a671 as S
WHERE NOT EXISTS (
...
GO
DROP TABLE #tmp_36e22d6e39a4498581269290c771a671
GO
