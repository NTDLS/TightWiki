CREATE TABLE #tmp_a141d2ce86cc45ea8e61ce8886f5bb42 ([Id] [int],[ConfigurationGroupId] [int],[Name] [nvarchar](128),[Value] [nvarchar](max),[DataTypeId] [int],[Description] [nvarchar](1000),[IsEncrypted] [bit])
GO

INSERT INTO #tmp_a141d2ce86cc45ea8e61ce8886f5bb42 ([ConfigurationGroupId],[Name],[Value],[DataTypeId],[Description],[IsEncrypted]) VALUES
(1,'Address','http://localhost',2,'the address of your wiki.',0),
(1,'Allow Guests to View History','1',3,'Whether guests can view page history.',0),
...
(1,'Pagination Size','10',1,'the number of items to return when pagination is used.',0),
...
(4,'Account Verification Email Template','<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
',2,'HTML email template for new account verification',0),
...
INNER JOIN #tmp_a141d2ce86cc45ea8e61ce8886f5bb42 as S
...
SELECT
	[ConfigurationGroupId],[Name],[Value],[DataTypeId],[Description],[IsEncrypted]
FROM #tmp_a141d2ce86cc45ea8e61ce8886f5bb42 as S
WHERE NOT EXISTS (
...
GO
DROP TABLE #tmp_a141d2ce86cc45ea8e61ce8886f5bb42
GO
